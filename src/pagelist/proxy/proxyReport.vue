    ...
    <div class="section is-radiusless box" style="width:100%">
        ...
        <div class="is-radiusless box">
            ...
            <b-field label="Faculty Name">
              <b-select :disabled="!isAuthorizedRoleList(['CMSADMIN','HOD'])" v-model="proxyReportDt.faculty" expanded>
        ...
        <div v-if="proxyReportDt.faculty">
          <ProxyAssignedReport :ayId="proxyReportDt.academicYear" :faculty="proxyReportDt.faculty"/>
      </div>
    </div>
  </template>
...
<script>
    ...
    export default {
        ...
        watch: {
            ...
            loggedInUser(){
              this.proxyReportDt.dept=this.loggedInUser.deptId
