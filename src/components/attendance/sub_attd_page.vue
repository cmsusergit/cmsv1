<template>
    <div class="section is-radiusless box" style="width:100%">
            ...
            <b-field grouped>
                ...
                <b-field grouped>
                  <b-field  label="Class Name" expanded>
                    <b-select :disabled="!dt.fDeptId" @input="classChanged"  v-model="dt.classId" expanded>
                ...
                <b-field  label="Subject Name" expanded>
                  <b-select :disabled="!dt.classId" v-model="dt.fSubjectId" expanded>
        ...
        <div v-if="dt && dt.classId && dt.ayId && dt.fSubjectId">
          <AttendanceReport :ayId="dt.ayId" :classId="dt.classId" :ttSubjectId="dt.fSubjectId" :batchId="dt.fBatchId" :loadType="dt.loadType"/>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        computed: {
            ...
            subjectList() {
                return this.$store.getters['subjectStore/getSubjectListByClassId'];
            },
            batchList(){
        ...
        methods: {
          ...
          classChanged(vv){
            ...
            this.$store.dispatch('subjectStore/getSubjectListByClassId',ob)
          },
        }
};
</script>
